...
function scrollTo(el) {
	$("html,body").animate({scrollTop:$(el).offset().top-parseInt($(".header_holder").css("height"))-10},200);
}

function scrollToTop() {
	$("html,body").animate({scrollTop:parseInt($(".header_holder").css("height"))-10},200);
}
