...
jQuery.extend(weibo.plugin.goods, {
    html:'<div id="goods_input">请输入商品网址（暂只支持淘宝）： <div><input name="publish_type_data" type="text" style="width: 235px" class="text mr5" value="" /><input type="button" class="btn_b" onclick="weibo.plugin.goods.add_goods()" value="添加"></div> </div>  ',
